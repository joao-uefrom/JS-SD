...
public class AdicionarProduto extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro remoto: " + re.toString(),
                    "Erro remoto", JOptionPane.WARNING_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Erro local: " + e.toString(),
                    "Erro local", JOptionPane.WARNING_MESSAGE);
        }
    }
